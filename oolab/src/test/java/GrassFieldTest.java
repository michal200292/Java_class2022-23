...
public class GrassFieldTest{
    ...
    @Test
    void test_map2() {
        MoveDirection[] directions = OptionParser.parse(new String[]{"f", "l", "b", "r", "f", "l", "f", "f", "f", "r",
    ...
    @Test
    void test_map3() {
        MoveDirection[] directions = OptionParser.parse(new String[]{"f", "f", "f", "f", "f", "f", "r", "l", "r", "l",
                "r", "l", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f"});
        IWorldMap map = new GrassField(10);
        Vector2d[] positions = { new Vector2d(0,0), new Vector2d(0,1),
                new Vector2d(0,2), new Vector2d(0,3), new Vector2d(0,4), new Vector2d(0,5)};
        IEngine engine = new SimulationEngine(directions, map, positions);
        engine.run();
    ...
    @Test
    void test_map4() {
        MoveDirection[] directions = OptionParser.parse(new String[]{"f", "l", "f", "f", "f", "f", "r", "f", "f", "f",
                "f", "f", "r", "f", "f", "f", "f", "f"});
        IWorldMap map = new GrassField(2);
        Vector2d[] positions = { new Vector2d(0,0)};
        IEngine engine = new SimulationEngine(directions, map, positions);
        engine.run();
        assertTrue(map.objectAt(new Vector2d(1, 6)) instanceof Animal);
    }
    @Test
    void test_map5() {
        MoveDirection[] directions = OptionParser.parse(new String[]{"l", "r", "f", "f", "r", "l", "r", "f", "f", "f",
                "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "r", "r", "l", "r", "f", "f", "f", "f", "f",
                "f", "f", "f", "f", "r", "f", "f", "f", "f", "f", "f", "r"});
